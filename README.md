...
```
wget https://github.com/c-bata/kube-prompt/releases/download/1.0.9/kube-prompt_1.0.9_darwin_amd64.zip
unzip kube-prompt_1.0.9_darwin_amd64.zip
chmod +x kube-prompt
...
```
wget https://github.com/c-bata/kube-prompt/releases/download/1.0.9/kube-prompt_1.0.9_linux_amd64.zip
unzip kube-prompt_1.0.9_linux_amd64.zip
chmod +x kube-prompt
sudo mv ./kube-prompt /usr/local/bin/kube-prompt
```
...
```
wget https://github.com/c-bata/kube-prompt/releases/download/1.0.9/kube-prompt_v1.0.9_linux_386.zip
...
```
wget https://github.com/c-bata/kube-prompt/releases/download/v1.0.9/kube-prompt_v1.0.9_linux_arm64.zip
unzip kube-prompt_v1.0.9_linux_arm64.zip
chmod +x kube-prompt
sudo mv ./kube-prompt /usr/local/bin/kube-prompt
```
